---
name: performance-frontend-javascript-performance
description: "USE FOR: JavaScript-specific performance — V8 optimization, event loop, Web Workers, memory leaks, efficient DOM manipulation, requestAnimationFrame."
---
