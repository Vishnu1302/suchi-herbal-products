...
export const MOCK_PRODUCTS: Product[] = [
  ...
  {
    id: "prod-007",
    name: "Aloe Neem Face Gel",
    slug: "aloe-neem-face-gel",
    description:
      "Lightweight cooling gel with aloe vera and neem for oily and acne-prone skin.",
    ingredients: "Aloe vera, Neem extract, Tea tree oil, Cucumber",
    usage: "Apply a thin layer on cleansed face twice daily.",
    benefits: "Oil control, acne reduction, hydration",
    price: 199,
    images: [
